...
#define GLOBAL_STATE_PTR_ADDR (LIBCLIENT_BASE + 0x3a71fb0 - START_ADDR)
#define LOCAL_PLAYER_CTL_PTR_ADDR (LIBCLIENT_BASE + 0x3a6cf38 - START_ADDR)
#define PAWN_ARRAY_ADDR (LIBCLIENT_BASE + 0x38d8af8 - START_ADDR)
